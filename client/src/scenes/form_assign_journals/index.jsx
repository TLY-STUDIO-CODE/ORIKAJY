...
const saveJournal = async(e) =>{
    e.preventDefault();
    try {
        await axios.post('http://localhost:5000/Journals/assign-entries', {
            
            journalName: journalName,
            description: description,
        });
        toast.success("Le journal est assigné avec succès!", {
    ...
    return (
        <Box m="20px">
            <Header title="ASSIGNER UN JOURNAL" subtitle="Formulaire d'assignation un journal à un écriture comptable" />
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            ...
                            <TextField
                                ...
                                variant="filled"
                                type="text"
                                label="Description de l'écriture comptable"
                                onBlur={handleBlur}
