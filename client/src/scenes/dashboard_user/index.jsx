 ...
 {/* ROW 3 */}
        ...
        >
          ...
          >
            ...
            <Typography
              variant="h5"
              color={progressCommande === 1 ? colors.grey[100] : colors.grey[100]}
              sx={{ mt: "15px" }}
            >
              {totalMontant} AR
            </Typography>
        ...
        >
          ...
          >
            ...
            <Typography
              variant="h5"
              color={progressAchat === 1 ? colors.grey[100] : colors.grey[100]}
              sx={{ mt: "15px" }}
            >
              {montantTotal} AR
            </Typography>
        ...
        >
          ...
          >
            ...
            <Typography
              variant="h5"
              color={progressVente2 === 1 ? colors.grey[100] : colors.grey[100]}
              sx={{ mt: "15px" }}
            >
              {montantTotal2} AR
            </Typography>
