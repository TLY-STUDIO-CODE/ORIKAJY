...
const saveAccountingEntry = async(e) =>{
    ...
    try {
        ...
        toast.success("Nouvelle écriture comptable créée avec succès!", {
    ...
    return (
        <Box m="20px">
            <Header title="NOUVELLE ECRITURE COMPTABLE" subtitle="Formulaire de création d'une nouvelle écriture comptable" />
