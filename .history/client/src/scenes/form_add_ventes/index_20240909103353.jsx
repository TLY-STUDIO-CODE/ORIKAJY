...
const saveVente = async(e) =>{
    ...
    return (
        <Box m="20px">
            <Header title="NOUVEAU VENTES" subtitle="Vendre un nouveau de produit" />
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            ...
                            <TextField
                                ...
                                helperText={touched.date_vente && errors.date_vente}
                                sx={{ gridColumn: "span 2" }}
                            />
                            <TextField
                                fullWidth
                        ...
                        <Box display="flex" justifyContent="end" mt="20px">
                            <Button type="submit" color="secondary" variant="contained" onClick={saveVente}>
                                Vendre
                            </Button>
                        </Box>
                        {msg && <p>{msg}</p>}
