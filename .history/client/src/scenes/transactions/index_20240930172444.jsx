...
const handleCloseDeleteModal = () => {
    ...
    const handleGenerateInvoice = () => {
        if (selectedRowData) {
            ...
            doc.text(`Prix unitaire : ${selectedRowData.montants.join(", ")} AR`, 20, 60);
            doc.text(`Prix total : ${selectedRowData.montant_total} AR`, 20, 70);
            doc.text(`Date du transaction : ${selectedRowData.date_transaction}`, 20, 80);
            doc.text(`Numéro de facturation : ${selectedRowData.num_factT}`, 20, 90);
            
            // Générer et télécharger le fichier PDF
            doc.save("Données_transactions.pdf");
        }
    };
...
const deleteTransactions = async (transactionId) => {
        try {
            ...
            getTransactions();
            toast.success("Le transaction est supprimé avec succès!", {
    ...
    const columns = [
        ...
        {
            field: "descriptions",
            headerName: "Déscription du transactions",
            flex: 1,
...
<Modal open={openModal} onClose={handleCloseModal}>
    ...
    >
        <Typography id="modal-modal-title" variant="h6" component="h2">
            IMPRIMER LES DONNEES DU TRANSACTION
        </Typography>
        ...
        {selectedRowData && (
            <Box>
                ...
                <Typography variant="body1">Déscription du transaction: {selectedRowData.descriptions.join(", ")}</Typography>
