...
const Transactions = () => {
    ...
    // Fonction pour regrouper les transactions par num_factT
    ...
    const getTransactions = async () => {
        try {
            ...
            // Ajoutez éventuellement une gestion d'état pour les erreurs
        }
    };
    ...
    const deleteTransactions = async (transactionId) => {
        try {
            ...
            getTransactions(); // Recharger les transactions après suppression
        } catch (error) {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box>
                    <IconButton
                        onClick={() => deleteTransactions(params.row.num_factT)} // Assurez-vous que num_factT est l'identifiant correct
                        color="secondary"
                    >
                        <DeleteIcon />
                    </IconButton>
    ...
    return (
        <Box m="20px">
            <Header title="LISTE DES TRANSACTIONS" subtitle="Liste de toutes les transactions" />
            <Box
                m="40px 0 0 0"
                height="75vh"
                sx={{
