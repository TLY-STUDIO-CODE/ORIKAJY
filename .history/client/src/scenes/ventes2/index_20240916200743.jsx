...
const Ventes2 = () => {
    ...
    const handleGenerateInvoice = () => {
        if (selectedRowData) {
            ...
            doc.text(`Total Montant: ${selectedRowData.montant_total} €`, 20, 40);
                ...
                >
                    ...
                    {selectedRowData && (
                        <Box>
                            ...
                            <Typography variant="body1">Total: {selectedRowData.montant_total} €</Typography>
