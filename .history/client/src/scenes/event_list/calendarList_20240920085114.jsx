...
if (dialogMode === 'add') {
    ...
    getEvents();
    toast.success("Evénement a été mise à jour avec succès!", {
...
return (
<Box m="20px">
    <Header title="Événements" subtitle="Liste de tous les événements notés par un utilisateur" />
    ...
    <Box
        ...
        sx={{ height: '100%' }}
    >
        <Typography variant="h5">Table des événements</Typography>
        <Box
        m="40px 0 0 0"
        height="100%"
        sx={{
