...
const EditUser = () => {
    ...
    useEffect(() => {
        const getUserById = async () => {
            try {
                ...
                setImage(response.data.image); // Mettre à jour l'URL de l'image
            } catch (error) {
                if (error.response) {
    ...
    const updateUser = async (e) => {
        ...
        try {
            ...
            toast.success("Les données de l'utilisateur a été mise à jour avec succès!", {
    ...
    return (
        <Box m="20px">
            <Header title="METTRE A JOUR UTILISATEUR" subtitle="Formulaire de mise à jour d'un utilisateur" />
