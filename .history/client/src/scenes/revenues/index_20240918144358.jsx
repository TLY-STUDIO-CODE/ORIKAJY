...
const Revenues = () => {
    ...
    const filterRevenus = () => {
        if (searchType && searchValue) {
            const filtered = revenus.filter(revenu => {
                if (searchType === 'revenuTotal') {
                    return revenu.revenuTotal.toString().includes(searchValue);
                } else if (searchType === 'date') {
                    return revenu.date.includes(searchValue);
                }
                return false;
            });
            setFilteredRevenus(filtered);
        } else {
            setFilteredRevenus(revenus);
        }
    };
