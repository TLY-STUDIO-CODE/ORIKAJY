   ...
   const fetchAllData = async () => {
        try {
            ...
            const data = {
                ...
                beneficeTotal: beneficesResponse.data.benefice,
    ...
    return (
        <Box m="20px">
        <Header title="RAPPORTS FINANCIERS" subtitle="Rapports détaillés des ventes, des achats, des revenus, des bénéfices et des pertes" />
