...
const Revenues = () => {
    ...
    const fetchAllData = async () => {
        try {
            const [ventesResponse, depensesResponse, revenusResponse, pertesResponse, beneficeResponse] = await Promise.all([
            ...
            const data = {
                ...
                beneficeTotal: beneficeResponse.data.benefice,
                pertes: pertesResponse.data.perte,
            };
    ...
    return (
        ...
        <Header title="FINANCIERS" subtitle="Rapports sur les Ventes, les Achats, les Revenus et Pertes" />
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                <Typography variant="h6">Bénéfice</Typography>
                    <Card>
                        <CardContent>
                            <Typography variant="h6">Bénéfice par date:</Typography>
                            <Typography variant="body1">{beneficeByDate} AR</Typography>
                            <Typography variant="h6">Bénéfice Total:</Typography>
                            <Typography variant="body1">{beneficeTotal} AR</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item xs={12} md={4}>
                 ...
                 {/* Revenus Buttons */}
                    ...
                    <Grid item xs={12} md={4}>
                        <Grid container spacing={2}>
                            <Grid item>
                                <Button
                                    onClick={handleFetchBeneficeByDate}
                                    variant="outlined"
                                    color="info"
                                >
                                    Obtenir bénéfice par Date
                                </Button>
                            </Grid>
                            <Grid item>
                                <Button
                                    onClick={handleFetchBeneficeTotal}
                                    variant="outlined"
                                    color="info"
                                >
                                    Obtenir Bénéfice Total
                                </Button>
                            </Grid>
                        </Grid>
                    </Grid>
