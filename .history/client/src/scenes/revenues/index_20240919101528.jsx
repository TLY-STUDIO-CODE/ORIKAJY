...
const Revenues = () => {
    ...
    const [totalVentesByDate, setTotalVentesByDate] = useState(0);
    ...
    const handleFetchRevenusTotal = async () => {
      ...
      const handleFetchTotalVentesByDate = async () => {
        try {
            ...
            setTotalVentesByDate(response.data.totalVentesByDate);
        } catch (error) {
    ...
    return (
        <Box m="20px">
            ...
            <Box mt="20px">
                <Typography variant="h6">Total Ventes par date: {totalVentesByDate} AR</Typography>
