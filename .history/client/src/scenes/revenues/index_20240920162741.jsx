...
const Revenues = () => {
        ...
        if (allData) {
            ...
            doc.autoTable({
                ...
                body: [
                    ...
                    ['Bénéfice Total', `${allData.beneficeTotal || 0} AR`],
    ...
    const fetchAllData = async () => {
        try {
            ...
            const data = {
                totalVentes: ventesResponse.data.totalVentes || 0,
                depenseTotal: depensesResponse.data.totalDepenses || 0,
                revenuTotal: revenusResponse.data.revenuTotal || 0,
                beneficeTotal: beneficesResponse.data.beneficeTotal || 0,
                pertes: pertesResponse.data.pertes || 0,
            };
    ...
    return (
        <Box m="20px">
            <Header title="FINANCIERS" subtitle="Rapports sur les Ventes, Dépenses, Revenus, Bénéfices et Pertes" />
            ...
            <Modal open={openModal} onClose={handleCloseModal}>
                <Box sx={{ 
                    ...
                    <Typography variant="h6">RAPPORT COMPLET</Typography>
                    {allData && (
                        <Box>
                            ...
                            <Typography variant="body1">Bénéfice Total: {allData.beneficeTotal} AR</Typography>
            ...
            <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                    <Card>
                        <CardContent>
                            ...
                            <Typography variant="body1">Total Ventes: {totalVentes} AR</Typography>
                            <Typography variant="body1">Total Ventes par date: {totalVenteByDate} AR</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item xs={12} md={6}>
                    <Card>
                        <CardContent>
                            ...
                            <Typography variant="body1">Total Dépenses: {depenseTotal} AR</Typography>
                            <Typography variant="body1">Total Dépenses par date: {depenseByDate} AR</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                    <Card>
                        <CardContent>
                            ...
                            <Typography variant="body1">Total Revenus: {revenuTotal} AR</Typography>
                            <Typography variant="body1">Total Revenus par date: {revenuByDate} AR</Typography>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                    <Card>
                        <CardContent>
                            <Typography variant="h6">Bénéfices</Typography>
                            <Typography variant="body1">Total Bénéfices: {beneficeTotal} AR</Typography>
                            <Typography variant="body1">Total Bénéfices par date: {beneficeByDate} AR</Typography>
                        </CardContent>
                    </Card>
                </Grid>
            </Grid>
