        ...
        <Box m="20px">
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                    <Card>
                        <CardContent>
                            <Typography variant="h6">Total Achats par date:</Typography>
                            <Typography variant="body1">{depenseByDate} AR</Typography>
                            <Typography variant="h6">Total Achats:</Typography>
                            <Typography variant="body1">{depenseTotal} AR</Typography>
                            <Typography variant="h6">Total Revenu par date:</Typography>
                            <Typography variant="body1">{revenuByDate} AR</Typography>
                            <Typography variant="h6">Total Revenu:</Typography>
                            <Typography variant="body1">{revenuTotal} AR</Typography>
                            <Typography variant="h6">Total Pertes par date:</Typography>
                            <Typography variant="body1">{pertesByDate} AR</Typography>
                            <Typography variant="h6">Total Pertes:</Typography>
