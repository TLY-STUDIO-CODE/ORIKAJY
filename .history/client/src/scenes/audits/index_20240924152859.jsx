...
const AuditAdmin = () => {
    ...
    useEffect(() => {
        const fetchLogs = async () => {
            try {
                const loginResponse = await axios.get('http://localhost:5000/audits/login');
                const activityResponse = await axios.get('http://localhost:5000/audits/activity');
        ...
        socket.on('auditLog', (newLog) => {
            // Ajouter le nouveau log à la liste des logs
