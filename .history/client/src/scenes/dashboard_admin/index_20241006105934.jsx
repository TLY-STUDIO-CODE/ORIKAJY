...
const [vente2Count, setVente2Count] = useState(0); 
  ...
  // Par exemple, un maximum pour le pourcentage
const maxCommandes = 100;

// Fonction pour calculer le pourcentage
const calculatePercentage = () => {
  return (commandeCount / maxCommandes) * 100;
};
...
>
  ...
  <Box
    ...
    mt="25px"
  >
    {/* Affichage du ProgressCircle avec un pourcentage calculé */}
    <ProgressCircle size="125" value={calculatePercentage()} />

    {/* Affichage du nombre de commandes récupéré */}
    <Typography
      variant="h5"
      color={colors.greenAccent[500]}
      sx={{ mt: "15px" }}
    >
      {commandeCount} commandes effectuées
    </Typography>
