...
const maxCommandes = 500; // Objectif des commandes
const progress = Math.min(commandeCount / maxCommandes, 1); 
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography
              variant="h5"
              color={progress === 1 ? colors.greenAccent[500] : colors.greenAccent[500]}
              sx={{ mt: "15px" }}
            >
