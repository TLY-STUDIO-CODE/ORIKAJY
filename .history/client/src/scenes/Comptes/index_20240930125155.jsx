...
const handleGenerateInvoice = () => {
    if (selectedRowData) {
        ...
        doc.text(`Type du compte: ${selectedRowData.type} AR`, 20, 30);
...
return (
<Box m="20px">
<Header title="Comptes" subtitle="Liste de tous les comptes" />
<Box
    m="40px 0 0 0"
    height="75vh"
    sx={{
            ...
            >
                ...
                {selectedRowData && (
                    <Box>
                        ...
                        <Typography variant="body1">Type du compte: {selectedRowData.type} AR</Typography>
