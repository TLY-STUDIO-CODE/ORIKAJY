...
const Commandes = () => {
    ...
    const handleGenerateInvoice = () => {
        if (selectedRowData) {
            ...
            doc.text(`Date de commande: ${selectedRowData.date_commande}`, 20, 90);
            doc.text(`Numéro de facturation: ${selectedRowData.num_factC}`, 20, 100);
            doc.text(`Total Montant: ${selectedRowData.montant_totalC} ar`, 20, 110);
