...
const Commandes = () => {
    ...
    const handleGenerateInvoice = () => {
        if (selectedRowData) {
            ...
            doc.text(`Descriptions de commande: ${selectedRowData.descriptions.join(", ")}`, 20, 40);
            ...
            doc.text(`Date de commande: ${selectedRowData.date_commande}`, 20, 80);
            doc.text(`Numéro de facturation: ${selectedRowData.num_factC}`, 20, 90);
            doc.text(`Total Montant: ${selectedRowData.montant_totalC} ar`, 20, 100);
    ...
    const printInvoice = (commande) => {
        ...
        printWindow.document.write(`<p>Produits: ${commande.names.join(", ")}</p>`);
        printWindow.document.write(`<p>Descriptions de commande: ${commande.descriptions.join(", ")}</p>`);
        ...
        printWindow.document.write(`<p>Prix unitaire de produit: ${commande.montants.join(", ")}</p>`);
        ...
        printWindow.document.write(`<p>Total Montant: ${commande.montant_totalC} AR</p>`);
    ...
    return (
        <Box m="20px">
            <Header title="LISTE DES COMMANDES" subtitle="Liste de tous les commandes de produit" />
            <Box
                m="40px 0 0 0"
                height="75vh"
                sx={{
                ...
                >
                    ...
                    {selectedRowData && (
                        <Box>
                            ...
                            <Typography variant="body1">Total: {selectedRowData.montant_totalC} AR</Typography>
