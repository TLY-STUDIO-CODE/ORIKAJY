...
const updateStock = async(e) =>{
    ...
    try {
        ...
        toast.success("Les données de stock a été mise à jour avec succès!", {
    ...
    return (
        <Box m="20px">
            <Header title="METTRE A JOUR STOCK" subtitle="Formulaire de Mmise à jour d'un stock de produit" />
