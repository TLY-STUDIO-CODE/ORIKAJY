...
const handleGenerateInvoice = () => {
    if (selectedRowData) {
        ...
        doc.text(`Prix unitaire de produit: ${selectedRowData.price} AR`, 20, 40);
        doc.text(`Numéro de facturation: ${selectedRowData.num_factP}`, 20, 50);
...
return (
<Box m="20px">
<Header title="PRODUITS" subtitle="Liste de tous les produits" />
<Box
    m="40px 0 0 0"
    height="75vh"
    sx={{
            ...
            >
                ...
                {selectedRowData && (
                    <Box>
                        ...
                        <Typography variant="body1">Prix: {selectedRowData.price} AR</Typography>
                        <Typography variant="body1">Numéro de facturation: {selectedRowData.num_factP}</Typography>
                    </Box>
                )}
