...
const saveStock = async(e) =>{
    ...
    try {
        ...
        toast.success('Stock créé avec succès!', { autoClose: 5000 });
        navigate("/stocks");
    } catch (error) {
        if(error.response) {
            setMsg(error.response.data.msg);
            toast.error(`Erreur: ${error.response.data.msg}`, { autoClose: 5000 });
        }
    }
};
    ...
    return (
        <Box m="20px">
            <Header title="NOUVEAU STOCK" subtitle="Créer un nouveau stock de produit" />
