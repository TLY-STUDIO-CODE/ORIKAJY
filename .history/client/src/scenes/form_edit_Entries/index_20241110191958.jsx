...
const updateAccountingEntry = async(e) =>{
    ...
    try {
        ...
        toast.success("L' écriture comptable est mis à avec succès!", {
    ...
    return (
        <Box m="20px">
            <Header title="MISE A JOUR D'UNE ECRITURE COMPTABLE" subtitle="Formulaire de mise à jour d'un écriture comptable" />
