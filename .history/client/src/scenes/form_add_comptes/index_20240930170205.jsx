...
const saveACompte = async(e) =>{
    ...
    return (
        <Box m="20px">
            <Header title="NOUVEAU COMPTE" subtitle="Formulaire de création un compte du plan comptable" />
                ...
                {({
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Box display="flex" justifyContent="end" mt="20px">
                            <Button type="submit" color="secondary" variant="contained" onClick={saveACompte}>
                                Créer
                            </Button>
                        </Box>
                        {msg && <p>{msg}</p>}
