...
const handleCloseDeleteModal = () => {
    ...
    const handleGenerateInvoice = () => {
        if (selectedRowData) {
            ...
            doc.text(`Catégorie: ${selectedRowData.categories}`, 20, 50);
            doc.text(`Prix unitaire: ${selectedRowData.montantS} AR`, 20, 60);
            doc.text(`Date de mise en stock: ${selectedRowData.date_stock}`, 20, 70);
            doc.text(`Numéro de facturation: ${selectedRowData.num_fact}`, 20, 80);
            doc.text(`Prix total: ${selectedRowData.montant_totalS} AR`, 20, 90);
...
{/* Modal pour générer la facture */}
            <Modal open={openModal} onClose={handleCloseModal}>
                ...
                >
                    ...
                    <Button onClick={handleGenerateInvoice} variant="contained" color="primary" sx={{ mr: 2 }}>
                        Imprimer
                    </Button>
