...
const handleCloseDeleteModal = () => {
    ...
    const handleGenerateInvoice = () => {
        if (selectedRowData) {
            ...
            doc.text(`Prix total : ${selectedRowData.montant_totalS} AR`, 20, 80);
            doc.text(`Date de mise en stock : ${selectedRowData.date_stock}`, 20, 90);
            doc.text(`Numéro de facturation : ${selectedRowData.num_fact}`, 20, 100);
