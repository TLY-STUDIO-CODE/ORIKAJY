  ...
  return (
    <>
      ...
      <ResponsiveLine
        ...
        xScale={{
          type: "time",        // Utilisez "time" pour l'axe x pour les dates
          min: "2024-01-01",   // Date minimum (peut être une date spécifique)
          max: "2024-12-31",   // Date maximum (peut être une date spécifique)
          stacked: false,      // Non empilé, car vous n'allez pas empiler les points de données
          reverse: false,      // L'axe dans l'ordre normal
        }}

        yScale={{
          type: "linear",      // Utilisez "linear" pour l'axe y pour les montants
          min: 0,              // Valeur minimale pour les montants
          max: "auto",         // Auto pour laisser l'échelle s'ajuster aux données
          stacked: false,      // Non empilé
          reverse: false,      // L'axe dans l'ordre normal
        }}
