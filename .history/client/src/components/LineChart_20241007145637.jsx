  ...
  return (
    <>
      ...
      <ResponsiveLine
        ...
        xScale={{
          type: "point",
          // Afficher tous les jours de l'année (0-31)
          domain: [0, 31],
        }}
        yScale={{
          type: "linear",
        ...
        axisBottom={{
          ...
          tickPadding: 5,
          tickRotation: 0,
          legend: isDashboard ? undefined : "Jours de l'année", // Légende pour l'axe X
          legendOffset: 36,
        ...
        axisLeft={{
          ...
          tickPadding: 5,
          tickRotation: 0,
          legend: isDashboard ? undefined : "Montant (Ar)", // Légende pour l'axe Y
          legendOffset: -40,
          legendPosition: "middle",
          // Colorer les ticks
          tickColor: colors.grey[400],
