        ...
        try {
          ...
          if (financialData) {
            const formattedData = [
              ...
              {
                id: "Ventes",
                color: tokens("dark").purpleAccent[400], // Couleur pour les ventes
                data: [{ x: date, y: financialData.ventes }],
              },
              {
                id: "Revenus",
                color: tokens("dark").orangeAccent[400], // Couleur pour les revenus
                data: [{ x: date, y: financialData.revenus }],
              },
            ];
