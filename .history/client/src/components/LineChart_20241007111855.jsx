...
const LineChart = ({ date, isCustomLineColors = false }) => {
  ...
  return (
    <>
      <ToastContainer /> {/* Ajout du composant ToastContainer pour afficher les notifications */}
      <ResponsiveLine
        data={lineData}
        theme={{
          axis: {
        ...
        colors={isCustomLineColors ? { datum: "color" } : { scheme: "nivo" }} // Utilisation de schéma de couleurs Nivo
        ...
        yFormat=" >-.2f"
        curve="catmullRom" // Animation de courbe
        axisTop={null}
        axisRight={null}
        axisBottom={{
          orient: "bottom",
          ...
          tickPadding: 5,
          tickRotation: 0,
          legend: "Date", // Ajout d'une légende pour l'axe X
          legendOffset: 36,
        ...
        axisLeft={{
          ...
          tickPadding: 5,
          tickRotation: 0,
          legend: "Valeur", // Ajout d'une légende pour l'axe Y
          legendOffset: -40,
          legendPosition: "middle",
        }}
        enableGridX={false}
