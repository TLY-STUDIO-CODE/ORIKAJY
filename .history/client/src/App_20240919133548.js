...
function App() {
  ...
  // Assume you have a method to get the user's role (could come from auth or context)
  const userRole = "manager"; // For example, this could be 'admin', 'manager', or 'user'
        ...
        <div className="app">
          ...
          <main className="content">
            ...
            <Routes>
              ...
              {/* Block /products, /stocks, /achats, /commandes, /ventes2 routes for manager */}
              ...
              {/* Block /revenues and /transactions routes for user */}
              ...
              {/* Block /users routes for both manager and user */}
              {userRole !== "manger" && userRole !== "user" && (
                <>
