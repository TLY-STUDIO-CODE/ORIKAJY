...
export const createStock = async (req, res) => {
    ...
    try {
        ...
        io.emit('stock_notification', {
            message: `Le stock de produit ${name} de catégorie ${categories} est ${level} avec une quantité égale à ${qteNumber} ${unit}`,
            productName: name,
        ...
        io.emit('stock_notification', {
            message: `Le stock de produit ${name} de catégorie ${categories} est revenu à un niveau normal avec une quantité de ${qteNumber} ${unit}`,
            productName: name,
            stockLevel: qteNumber
        });
...
export const updateStock = async (req, res) => {
    try {
        ...
        // Si la quantité est rétablie à plus de 20
        io.emit('stock_notification', {
            message: `Stock de ${name} de catégorie ${categories} est revenu à un niveau normal avec une quantité de ${qteNumber}`,
            productName: name,
            stockLevel: qteNumber
        });
