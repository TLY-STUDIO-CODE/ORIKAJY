...
// Emit stock notifications to connected clients
const emitLowStockNotification = async () => {
    try {
        ...
        io.emit('low-stock-notification', { lowStockItems, veryLowStockItems });
    } catch (error) {
        console.error("Failed to emit low stock notifications", error);
    }
};