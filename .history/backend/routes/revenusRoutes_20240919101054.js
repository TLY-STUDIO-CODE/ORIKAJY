...
import { getRevenusByDate, getAllRevenus, getTotalRevenus, getTotalVenteByDate, getTotalVentes } from '../controllers/Revenus.js';
...
router.get('/ventes', verifyUser, getTotalVentes);
